...
test.skip("free tier: initialize, tools/list, add, move, board, overdue, timer handoff, project limit", async () => {
...
test.skip("pro tier: a signed key unlocks more projects, custom columns and past weeks", async () => {
